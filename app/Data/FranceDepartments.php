 ...
 * Hardcoded data for departments and regions
 */
class FranceDepartments
{
     ...
     * @var array
     */
    private static array $departmentsData = [
    ...
    /**
     * Hardcoded regions data
     *
     * @var array
     */
    private static array $regionsData = [
    ...
    {
        // No-op: data is hardcoded, nothing to clear
    }
}

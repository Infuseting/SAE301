...
export default function Register() {
    ...
    const submit = (e) => {
        ...
        // Check for redirect_uri in current URL
        const params = new URLSearchParams(window.location.search);
        const redirectUri = params.get('redirect_uri');

        post(route('register', { redirect_uri: redirectUri }), {
        ...
        <GuestLayout>
            ...
            <div className="mb-6">
                ...
                <p className="mt-2 text-sm text-gray-600 ">
                    ...
                    <Link
                        href={route('login', { redirect_uri: new URLSearchParams(window.location.search).get('redirect_uri') })}

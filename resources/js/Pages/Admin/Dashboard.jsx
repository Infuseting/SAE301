                        ...
                        <div className="bg-white p-6 shadow sm:rounded-lg flex flex-col justify-between">
                            <div>
                                ...
                                <p className="text-sm text-gray-500">
                                    Approuver ou rejeter les clubs en attente
                                </p>
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-sm text-gray-500 mt-1">
                                    Importer et gérer les résultats des courses
                                </p>
                            </div>
                            <svg
                                className="w-12 h-12 text-gray-400"
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="mt-5">
                                    ...
                                    <strong>{races.length}</strong> courses
                                </p>
                            </div>
                            <RiRunLine className="w-12 h-12 text-gray-400" />
                        </div>
                        <div className="mt-4">
                            <Link
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="mt-5">
                                    {" "}
                                    Vous êtes responsable de{" "}
                                    <strong>{raids.length}</strong> raids
                                </p>
                            </div>
                            <FaRegCompass className="w-12 h-12 text-gray-400" />
                        </div>
                        <div className="mt-4">
                            <Link

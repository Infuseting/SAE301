                        ...
                        <div className="lg:col-span-4 space-y-8">
                            ...
                            {race.raid && (
                                <div className="bg-white rounded-2xl p-6 border border-blue-50 shadow-sm space-y-4">
                                    ...
                                    <div className="space-y-3">
                                        <div>
                                            <p className="text-[10px] font-black text-blue-400 uppercase tracking-widest mb-1">NOM</p>
                                            <p className="text-xs font-bold text-blue-900 uppercase italic">{race.raid.nom}</p>
                                        </div>
                                        <div>
                                            <p className="text-[10px] font-black text-blue-400 uppercase tracking-widest mb-1">LIEU</p>
                                            <p className="text-xs text-blue-800">{race.raid.location}</p>
                                        </div>
                                        {race.raid.club && (
                                            <div>
                                    ...
                                    <Link href={route('raids.show', race.raidId)} className="block text-center text-[10px] font-black text-emerald-600 hover:text-emerald-700 uppercase tracking-wider py-2 border-t border-blue-50 mt-4">
                                        Voir le raid →
                                    </Link>
                                </div>
                            )}

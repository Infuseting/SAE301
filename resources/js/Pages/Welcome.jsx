                    ...
                    <div className="relative z-10 h-full flex flex-col items-center justify-center px-4 text-center">
                        ...
                        <p className="mt-4 max-w-2xl text-xl text-gray-200 mb-10 drop-shadow-md">
                            {messages.hero_subtitle ||
                                "Explorez des centaines de cartes et de parcours à travers la France. Du sprint urbain à l'ultra-longue distance en montagne."}
                        </p>
                        ...
                        <div className="flex justify-between items-end mb-12">
                            <div>
                                <h2 className="text-3xl font-bold text-gray-900">
                                    {messages.upcoming_races_title ||
                                        "Prochaines Courses"}
                                </h2>
                                <p className="mt-2 text-gray-600">
                                    {messages.upcoming_races_subtitle ||
                                        "Ne manquez pas les événements à venir près de chez vous."}
                                </p>
                            </div>
                            <a
                                href="#"
                        ...
                        <div className="text-center max-w-3xl mx-auto mb-16">
                            ...
                            <p className="text-gray-600 text-lg">
                                {messages.how_it_works_subtitle ||
                                    "Rejoignez la plus grande communauté de course d'orientation en France en quelques étapes."}
                            </p>
                        </div>
                            ...
                            <div className="text-center">
                                ...
                                <h3 className="text-xl font-bold text-gray-900 mb-3">
                                    {messages.step_1_title ||
                                        "1. Trouvez une course"}
                                </h3>
                                <p className="text-gray-500">
                                    {messages.step_1_desc ||
                                        "Utilisez nos filtres avancés pour trouver l'épreuve qui correspond à votre niveau et vos envies."}
                                </p>
                            </div>
                            <div className="text-center">
                                <div className="bg-white w-20 h-20 mx-auto rounded-3xl shadow-lg flex items-center justify-center mb-6 text-emerald-600">
                                ...
                                <p className="text-gray-500">
                                    {messages.step_2_desc ||
                                        "Créez votre compte, gérez vos licences et inscrivez-vous en quelques clics."}
                                </p>
                            </div>
                            <div className="text-center">
                                <div className="bg-white w-20 h-20 mx-auto rounded-3xl shadow-lg flex items-center justify-center mb-6 text-emerald-600">
                                ...
                                <h3 className="text-xl font-bold text-gray-900 mb-3">
                                    {messages.step_3_title || "3. Courez !"}
                                </h3>
                                <p className="text-gray-500">
                                    {messages.step_3_desc ||
                                        "Participez à l'événement, suivez vos résultats et comparez vos performances."}
                                </p>
                            </div>
                        </div>
                    </div>

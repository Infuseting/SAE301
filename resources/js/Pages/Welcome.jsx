                ...
                <div className="relative h-screen max-h-[900px]">
                    ...
                    <div className="absolute top-0 w-full z-20 p-6">
                        <header className="max-w-7xl mx-auto">
                            ...
                            <div className="hidden min-[401px]:flex items-start justify-between">
                                {/* Logo Pill */}
                                <div className="bg-white/95 backdrop-blur-sm rounded-full px-4 shadow-lg flex items-center h-14">
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="bg-white/95 backdrop-blur-sm rounded-full px-2 shadow-lg flex items-center h-14">
                                        <LanguageSwitcher className="text-gray-700 hover:text-emerald-600 transition" />
                                    </div>

                                    {/* Auth Pill */}
                                    <div className="bg-white/95 backdrop-blur-sm rounded-full px-5 shadow-lg flex items-center h-14">
                                        {auth.user ? (
                                            ...
                                            <>
                                                <div className="hidden lg:flex gap-4 items-center">
                                                    <Link
                                                        href={route('login')}
                                                        className="px-4 py-2 text-gray-700 hover:text-emerald-600 transition font-medium cursor-pointer"
                                                    >
                                                        {messages.login}
                                                    </Link>
                                                    <Link
                            ...
                            {/* Mobile Navigation - Single Long Pill */}
                            <div className="min-[401px]:hidden bg-white/95 backdrop-blur-sm rounded-full px-4 shadow-lg flex items-center justify-between h-14">
                                <ApplicationLogo className="h-10 w-auto fill-current text-gray-800" />

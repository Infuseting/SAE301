...
return [
    ...
    | défaut utilisés par le validateur. Certaines règles ont plusieurs
    | variantes (par exemple les règles de taille). Modifiez-les si besoin
    | pour mieux correspondre à votre application.
    |
    */
    ...
    'ascii' => 'Le champ :attribute doit uniquement contenir des caractères alphanumériques et symboles sur un octet.',
    ...
    'password' => [
        ...
        'uncompromised' => 'La valeur fournie pour :attribute est apparue dans une fuite de données. Veuillez choisir une autre valeur pour :attribute.',
    ],
    ...
    | des attributs en utilisant la convention "attribut.règle". Cela permet
    | de cibler rapidement un message spécifique pour une règle donnée.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes suivantes permettent de remplacer les noms d'attributs
    | (placeholders) par des libellés plus lisibles, par exemple
    | "Adresse e-mail" au lieu de "email". Cela rend les messages plus
